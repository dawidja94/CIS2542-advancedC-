...
int test8()
{
	...
	cout << "to sequenceDynamic of duplicate items." << endl;
	// try to erase item not found
	cout << "Attempting to erase item not in sequenceDynamic...";
	...
	for (i = 0; i < arrSize3; i++) {
		if (testDup.erase_one(items3[i])) {
			...
			cout << "\n\tverifying remaining items in sequenceDynamic...";
	...
	cout << "to sequenceDynamic of unique items." << endl;
